...
function App() {
  const [currentView, setCurrentView] = useState<'dashboard' | 'grid'>('dashboard');
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                ...
                <h1 className="hidden lg:block ml-4 text-xl font-semibold text-gray-900 dark:text-white">
